...
- Subject: Details regarding the context of the project, usually involving company profiles, product, customer list info, etc.
...
- Generate the system & architecture documentation,including
    ...
    - database schema
    - If there are critical & complex part, you can create specific documentation around certain part too (optional)
